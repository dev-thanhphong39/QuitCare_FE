...
const PaymentPage = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const res = await api.post(`/v1/payments/initiate/${pkg.id}/by-account/${accountId}`);
      ...
      } else if (typeof paymentData === "string" && paymentData.startsWith("redirect:")) {
